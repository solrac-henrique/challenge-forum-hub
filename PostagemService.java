package api.forumhub.domain.postagem.service;

import api.forumhub.domain.ValidacaoException;
import api.forumhub.domain.postagem.DadosDetalhamentoPostagem;
import api.forumhub.domain.postagem.DadosPostagem;
import api.forumhub.domain.postagem.Postagem;
import api.forumhub.domain.postagem.dto.DadosPostagemDTO;
import api.forumhub.domain.postagem.validation.ValidadorPostagem;
import api.forumhub.domain.usuario.AuthenticationLogin;
import api.forumhub.domain.usuario.Usuario;
import api.forumhub.repository.PostagemRepository;
